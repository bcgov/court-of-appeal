# Generated by Django 4.0.1 on 2022-02-13 17:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='change_of_address_id', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='FormPdf',
            fields=[
                ...
                ('change_of_address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='change_of_address_form_pdf', to='form18.changeofaddress')),
            ],
        ),
        migrations.AddConstraint(
            model_name='formpdf',
            constraint=models.UniqueConstraint(fields=('change_of_address_id', 'pdf_type'), name='unique_pdf_type_change_of_address_id'),
        ),
    ]
