...
from form18.form18_service.form_service import get_form, modify_form
...
class Form18FormsView(APIView):
    ...
    def delete(self, request: Request):
        ...
        body = request.data
        for id in body['ids']:
            change_of_address_query = ChangeOfAddress.objects.filter(id = id)
            change_of_address_query.delete()
