...
from form9.form9_service.form_service import get_form, modify_form
...
class Form9FormsView(APIView):
    ...
    def delete(self, request: Request):
        ...
        body = request.data
        for id in body['ids']:
            requisition_query = Requisition.objects.filter(id = id)
            requisition_query.delete()
