# Generated by Django 4.0.1 on 2022-05-11 21:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='order_nofees_payable_id', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='FormPdf',
            fields=[
                ...
                ('order_nofees_payable', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_nofees_payable_form_pdf', to='form22.ordernofeespayable')),
            ],
        ),
        migrations.AddConstraint(
            model_name='formpdf',
            constraint=models.UniqueConstraint(fields=('order_nofees_payable_id', 'pdf_type'), name='unique_pdf_type_order_nofees_payable_id'),
        ),
    ]
