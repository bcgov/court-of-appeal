...
class FormPdf(models.Model):
    ...
    order_nofees_payable = models.ForeignKey(
        "OrderNofeesPayable",
        related_name="order_nofees_payable_form_pdf",
        on_delete=models.CASCADE
    )

    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['order_nofees_payable_id', 'pdf_type'], name='unique_pdf_type_order_nofees_payable_id'),
        ]
