# Generated by Django 4.0.1 on 2022-05-23 23:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='order_of_three_justices_id', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='FormPdf',
            fields=[
                ...
                ('order_of_three_justices', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_of_three_justices_form_pdf', to='form11.orderofthreejustices')),
            ],
        ),
        migrations.AddConstraint(
            model_name='formpdf',
            constraint=models.UniqueConstraint(fields=('order_of_three_justices_id', 'pdf_type'), name='unique_pdf_type_order_of_three_justices_id'),
        ),
    ]
