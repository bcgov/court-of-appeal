...
class FormPdf(models.Model):
    ...
    order_of_three_justices = models.ForeignKey(
        "OrderOfThreeJustices",
        related_name="order_of_three_justices_form_pdf",
        on_delete=models.CASCADE
    )

    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['order_of_three_justices_id', 'pdf_type'], name='unique_pdf_type_order_of_three_justices_id'),
        ]
