...
class FormPdf(models.Model):
    ...
    notice_of_cross_appeal = models.ForeignKey(
        "NoticeOfCrossAppeal",
        related_name="notice_of_cross_appeal_form_pdf",
        on_delete=models.CASCADE
    )

    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['notice_of_cross_appeal_id', 'pdf_type'], name='unique_pdf_type_notice_of_cross_appeal_id'),
        ]
