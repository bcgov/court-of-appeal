# Generated by Django 4.0.1 on 2022-04-03 19:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='notice_of_cross_appeal_id', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='FormPdf',
            fields=[
                ...
                ('notice_of_cross_appeal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notice_of_cross_appeal_form_pdf', to='form3.noticeofcrossappeal')),
            ],
        ),
        migrations.AddConstraint(
            model_name='formpdf',
            constraint=models.UniqueConstraint(fields=('notice_of_cross_appeal_id', 'pdf_type'), name='unique_pdf_type_notice_of_cross_appeal_id'),
        ),
    ]
