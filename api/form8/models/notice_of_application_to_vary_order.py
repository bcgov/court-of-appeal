...
class NoticeOfApplicationToVaryOrder(models.Model):
    ...
    user = models.ForeignKey(
        "api.user",
        related_name="notice_of_application_to_vary_order_id",
    ...
    def save(self, *args, **kwargs):    
        ...
        return super(NoticeOfApplicationToVaryOrder, self).save(*args, **kwargs)