...
class ConsentRemoveInactiveAppeal(models.Model):
    ...
    user = models.ForeignKey(
        "api.user",
        related_name="consent_remove_inactive_appeal_id",
    ...
    def save(self, *args, **kwargs):    
        ...
        return super(ConsentRemoveInactiveAppeal, self).save(*args, **kwargs)