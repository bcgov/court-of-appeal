# Generated by Django 4.0.1 on 2022-05-27 18:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='ConsentRemoveInactiveAppeal',
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='consent_remove_inactive_appeal_id', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='FormPdf',
            fields=[
                ...
                ('consent_remove_inactive_appeal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consent_remove_inactive_appeal_form_pdf', to='form14.consentremoveinactiveappeal')),
            ],
        ),
        migrations.AddConstraint(
            model_name='formpdf',
            constraint=models.UniqueConstraint(fields=('consent_remove_inactive_appeal_id', 'pdf_type'), name='unique_pdf_type_consent_remove_inactive_appeal_id'),
        ),
    ]
