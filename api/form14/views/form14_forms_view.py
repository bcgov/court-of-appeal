...
from form14.form14_service.form_service import get_form, modify_form
...
class Form14FormsView(APIView):
    ...
    def delete(self, request: Request):
        ...
        body = request.data
        for id in body['ids']:
            consent_remove_inactive_appeal_query = ConsentRemoveInactiveAppeal.objects.filter(id = id)
            consent_remove_inactive_appeal_query.delete()
