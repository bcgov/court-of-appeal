...
class FormPdf(models.Model):
    ...
    certificate_of_costs = models.ForeignKey(
        "CertificateOfCosts",
        related_name="certificate_of_costs_form_pdf",
        on_delete=models.CASCADE
    )

    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['certificate_of_costs_id', 'pdf_type'], name='unique_pdf_type_certificate_of_costs_id'),
        ]
