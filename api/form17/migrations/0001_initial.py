# Generated by Django 4.0.1 on 2022-05-27 17:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='certificate_of_costs_id', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='FormPdf',
            fields=[
                ...
                ('certificate_of_costs', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='certificate_of_costs_form_pdf', to='form17.certificateofcosts')),
            ],
        ),
        migrations.AddConstraint(
            model_name='formpdf',
            constraint=models.UniqueConstraint(fields=('certificate_of_costs_id', 'pdf_type'), name='unique_pdf_type_certificate_of_costs_id'),
        ),
    ]
