...
from form10.form10_service.form_service import get_form, modify_form
...
class Form10FormsView(APIView):
    ...
    def delete(self, request: Request):
        ...
        body = request.data
        for id in body['ids']:
            order_of_single_justice_query = OrderOfSingleJustice.objects.filter(id = id)
            order_of_single_justice_query.delete()
