...
class FormPdf(models.Model):
    ...
    order_of_single_justice = models.ForeignKey(
        "OrderOfSingleJustice",
        related_name="order_of_single_justice_form_pdf",
        on_delete=models.CASCADE
    )

    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['order_of_single_justice_id', 'pdf_type'], name='unique_pdf_type_order_of_single_justice_id'),
        ]
