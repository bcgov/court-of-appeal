# Generated by Django 4.0.1 on 2022-05-22 16:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='order_of_single_justice_id', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='FormPdf',
            fields=[
                ...
                ('order_of_single_justice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_of_single_justice_form_pdf', to='form10.orderofsinglejustice')),
            ],
        ),
        migrations.AddConstraint(
            model_name='formpdf',
            constraint=models.UniqueConstraint(fields=('order_of_single_justice_id', 'pdf_type'), name='unique_pdf_type_order_of_single_justice_id'),
        ),
    ]
