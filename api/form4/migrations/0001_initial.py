# Generated by Django 4.0.1 on 2022-04-20 15:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='notice_of_application_id', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='FormPdf',
            fields=[
                ...
                ('notice_of_application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notice_of_application_form_pdf', to='form4.noticeofapplication')),
            ],
        ),
        migrations.AddConstraint(
            model_name='formpdf',
            constraint=models.UniqueConstraint(fields=('notice_of_application_id', 'pdf_type'), name='unique_pdf_type_notice_of_application_id'),
        ),
    ]
