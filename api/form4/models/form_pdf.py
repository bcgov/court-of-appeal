...
class FormPdf(models.Model):
    ...
    notice_of_application = models.ForeignKey(
        "NoticeOfApplication",
        related_name="notice_of_application_form_pdf",
        on_delete=models.CASCADE
    )

    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['notice_of_application_id', 'pdf_type'], name='unique_pdf_type_notice_of_application_id'),
        ]
