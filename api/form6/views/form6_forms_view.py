...
from form6.form6_service.form_service import get_form, modify_form
from form6.models import NoticeOfSettlement


LOGGER = logging.getLogger(__name__)


class Form6FormsView(APIView):
    ...
    def delete(self, request: Request):
        ...
        body = request.data
        for id in body['ids']:
            notice_query = NoticeOfSettlement.objects.filter(id = id)
            notice_query.delete()
