# Generated by Django 4.0.1 on 2022-05-27 17:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='consent_extend_filing_time_id', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='FormPdf',
            fields=[
                ...
                ('consent_extend_filing_time', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consent_extend_filing_time_form_pdf', to='form13.consentextendfilingtime')),
            ],
        ),
        migrations.AddConstraint(
            model_name='formpdf',
            constraint=models.UniqueConstraint(fields=('consent_extend_filing_time_id', 'pdf_type'), name='unique_pdf_type_consent_extend_filing_time_id'),
        ),
    ]
