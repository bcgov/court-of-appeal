# Generated by Django 4.0.1 on 2022-05-02 17:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='OrderToVaryOrderOfJustice',
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='order_to_vary_order_of_justice_id', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='FormPdf',
            fields=[
                ...
                ('order_to_vary_order_of_justice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_to_vary_order_of_justice_form_pdf', to='form12.ordertovaryorderofjustice')),
            ],
        ),
        migrations.AddConstraint(
            model_name='formpdf',
            constraint=models.UniqueConstraint(fields=('order_to_vary_order_of_justice_id', 'pdf_type'), name='unique_pdf_type_order_to_vary_order_of_justice_id'),
        ),
    ]
