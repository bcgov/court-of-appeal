...
class Holidays:
    ...
    def BcStats(self, year):
        return {
            "New Years Day " + str(year) : self.NewYearsDay(year).strftime("%Y-%m-%d"),
            "BC Family Day" : self.FamilyDay(year).strftime("%Y-%m-%d"),
            "Good Friday" : self.GoodFriday(year).strftime("%Y-%m-%d"),
            "Easter Monday" : self.EasterMonday(year).strftime("%Y-%m-%d"),
            "Victoria Day" : self.VictoriaDay(year).strftime("%Y-%m-%d"),
            "Canada Day" : self.CanadaDay(year).strftime("%Y-%m-%d"),
            "BC Day" : self.BcDay(year).strftime("%Y-%m-%d"),
            "Labour Day" : self.LabourDay(year).strftime("%Y-%m-%d"),
            "Truth and Reconciliation Day" : self.TruthReconciliationDay(year).strftime("%Y-%m-%d"),
            "Thanksgiving" : self.Thanksgiving(year).strftime("%Y-%m-%d"),
            "Remembrance Day" : self.RemembranceDay(year).strftime("%Y-%m-%d"),
            "Christmas Day" : self.ChristmasDay(year).strftime("%Y-%m-%d"),
            "Boxing Day" : self.BoxingDay(year).strftime("%Y-%m-%d"),
            "New Years Day " + str(year + 1) : self.NewYearsDay(year + 1).strftime("%Y-%m-%d"),
        }
