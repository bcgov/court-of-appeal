    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='withdraw_lawyer_id', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='FormPdf',
            fields=[
                ...
                ('withdraw_lawyer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='withdraw_lawyer_form_pdf', to='form19.withdrawlawyer')),
            ],
        ),
        migrations.AddConstraint(
            model_name='formpdf',
            constraint=models.UniqueConstraint(fields=('withdraw_lawyer_id', 'pdf_type'), name='unique_pdf_type_withdraw_lawyer_id'),
        ),
    ]
