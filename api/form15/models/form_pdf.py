...
class FormPdf(models.Model):
    ...
    consent_order_general = models.ForeignKey(
        "ConsentOrderGeneral",
        related_name="consent_order_general_form_pdf",
        on_delete=models.CASCADE
    )

    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['consent_order_general_id', 'pdf_type'], name='unique_pdf_type_consent_order_general_id'),
        ]
