# Generated by Django 4.0.1 on 2022-04-21 18:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='offer_to_settle_costs_id', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='FormPdf',
            fields=[
                ...
                ('offer_to_settle_costs', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='offer_to_settle_costs_form_pdf', to='form16.offertosettlecosts')),
            ],
        ),
        migrations.AddConstraint(
            model_name='formpdf',
            constraint=models.UniqueConstraint(fields=('offer_to_settle_costs_id', 'pdf_type'), name='unique_pdf_type_offer_to_settle_costs_id'),
        ),
    ]
