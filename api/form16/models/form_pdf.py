...
class FormPdf(models.Model):
    ...
    offer_to_settle_costs = models.ForeignKey(
        "OfferToSettleCosts",
        related_name="offer_to_settle_costs_form_pdf",
        on_delete=models.CASCADE
    )

    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['offer_to_settle_costs_id', 'pdf_type'], name='unique_pdf_type_offer_to_settle_costs_id'),
        ]
