    ...
    render() {
        return (
            <div className="form-section not-printable" ref={ (element)=> {this.element = element }}>
                ...
                <ol>
                    <li><button type="button" className="btn btn-link" id="form7" onClick={this.redirectToForm7} style={{cursor:'pointer', fontSize:'14px'}} >Notice of Appeal (Form 7)</button></li>
