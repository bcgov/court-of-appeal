...
Vue.filter('printPdf', function(html, pageFooterLeft, pageFooterRight){
	...
	const body = 
		...
		`<style>`+
			...
			`.coa-text-box-center{border: 1px solid black; word-wrap: break-word; padding:0rem 0.5rem; display:flex; align-items:center; justify-content:center; text-align:center;}`+
			`.coa-text-box-left  {border: 1px solid black; word-wrap: break-word; padding:0rem 0.5rem; display:flex; align-items:center; justify-content:left; text-align:left;}`+			
