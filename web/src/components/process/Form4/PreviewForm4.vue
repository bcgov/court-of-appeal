<template>
    <b-card v-if="dataReady" header-tag="header" bg-variant="light" border-variant="white" style="width: 80rem;" class="mx-auto">
        ...
        <b-card border-variant="light" bg-variant="light" class="mt-3 mx-4">
            <form-4 @navigateToSubmitPage="navigateToSubmitPage()" @pdfReady="pdfReady=true" />            
        </b-card> 
...
import Form4 from "@/components/process/Form4/components/pdf/Form4.vue"
...
export default class PreviewForm4 extends Vue {
    ...
    public navigateToSubmitPage() {
        this.$router.push({name: "proceed-form4"}); 
    }
}
</script>
