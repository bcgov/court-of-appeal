<template>
    <div v-if="dataReady" class="print-block">
        <div style="font-size:12pt; font-weight:600; margin-bottom: 0.5rem;" >Form 15: </div>
        <b-table            
            :items="form15_info"
            :fields="fields"
            bordered            
        ...
        <div style="font-size:10pt; margin-bottom: 0.5rem;">
            <b>Total Number of Form 15 Applications:</b> {{results.form15.total}} 
        </div>
        <div 
            v-if="displayTopUser" 
...
@Component
export default class Form15Table extends Vue {
    ...
    topUserFields = [
        ...
        {key:"drafted",      label:"Drafted",                thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'},
        {key:"unsuccessful", label:"Unsuccessful eFiling",   thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'},
        {key:"total",        label:"Total Form 15 Applications", thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'}
    ]; 
    ...
    public extractInfo(){
       this.form15_info = [this.results.form15];
       this.topUser_info = [this.results.form15.top_user];
    }
