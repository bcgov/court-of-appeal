<template>
    <div v-if="dataReady">
        <div style="font-size:12pt; font-weight:600; margin-bottom: 0.5rem;" >Form 4: </div>
        <b-table            
            :items="form4_info"
            :fields="fields"
            bordered            
        ...
        <div 
            ...
            <b>Total Number of Form 4 Applications:</b> {{results.form4.total}} 
        </div>
        <div 
            v-if="displayTopUser" 
...
@Component
export default class Form4Table extends Vue {
    ...
    topUserFields = [
        ...
        {key:"drafted",      label:"Drafted",                thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'},
        {key:"unsuccessful", label:"Unsuccessful eFiling",   thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'},
        {key:"total",        label:"Total Form 4 Applications", thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'}
    ]; 
    ...
    public extractInfo(){
       this.form4_info = [this.results.form4];
       this.topUser_info = [this.results.form4.top_user];
    }  
