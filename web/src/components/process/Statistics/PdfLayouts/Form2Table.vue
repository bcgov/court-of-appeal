<template>
    <div v-if="dataReady">
        <div style="font-size:12pt; font-weight:600; margin-bottom: 0.5rem;" >Form 2: </div>
        <b-table            
            :items="form2_info"
            :fields="fields"
            bordered            
        ...
        <div 
            ...
            <b>Total Number of Form 2 Applications:</b> {{results.form2.total}} 
        </div>
        <div 
            v-if="displayTopUser" 
...
@Component
export default class Form2Table extends Vue {
    ...
    topUserFields = [
        ...
        {key:"drafted",      label:"Drafted",                thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'},
        {key:"unsuccessful", label:"Unsuccessful eFiling",   thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'},
        {key:"total",        label:"Total Form 2 Applications", thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'}
    ]; 
    ...
    public extractInfo(){
       this.form2_info = [this.results.form2];
       this.topUser_info = [this.results.form2.top_user];
    }   
