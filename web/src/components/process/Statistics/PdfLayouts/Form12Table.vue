<template>
    <div v-if="dataReady">
        ...
        <div style="font-size:10pt; margin-bottom: 0.5rem;">
            <b>Total Number of Form 12 Applications:</b> {{results.form12.total}} 
        </div>
        <div 
            v-if="displayTopUser" 
...
@Component
export default class Form12Table extends Vue {
    ...
    topUserFields = [
        ...
        {key:"drafted",      label:"Drafted",                thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'},
        {key:"unsuccessful", label:"Unsuccessful eFiling",   thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'},
        {key:"total",        label:"Total Form 12 Applications", thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'}
    ]; 
    ...
    public extractInfo(){
       this.form12_info = [this.results.form12];
       this.topUser_info = [this.results.form12.top_user];
    } 
}
</script>