<template>
    <div v-if="dataReady">
        <div style="font-size:12pt; font-weight:600; margin-bottom: 0.5rem;" >Form 21: </div>
        <b-table            
            :items="form21_info"
            :fields="fields"
            bordered            
        ...
        <div style="font-size:10pt; margin-bottom: 0.5rem;">
            <b>Total Number of Form 21 Applications:</b> {{results.form21.total}} 
        </div>
        <div 
            v-if="displayTopUser" 
...
@Component
export default class Form21Table extends Vue {
    ...
    fields = [
        ...
        {key:"unsuccessful", label:"Unsuccessfull eFiling",  thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'},
    ...
    topUserFields = [
        ...
        {key:"total",        label:"Total Form 21 Applications", thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'}
    ]; 
    ...
    public extractInfo(){
       this.form21_info = [this.results.form21];
       this.topUser_info = [this.results.form21.top_user];
    }
