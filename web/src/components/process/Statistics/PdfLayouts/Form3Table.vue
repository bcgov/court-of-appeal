<template>
    <div v-if="dataReady">
        <div style="font-size:12pt; font-weight:600; margin-bottom: 0.5rem;" >Form 3: </div>
        <b-table            
            :items="form3_info"
            :fields="fields"
            bordered            
        ...
        <div style="font-size:10pt; margin-bottom: 0.5rem;" >
            <b>Total Number of Form 3 Applications:</b> {{results.form3.total}} 
        </div>
        <div 
            v-if="displayTopUser" 
...
@Component
export default class Form3Table extends Vue {
    ...
    topUserFields = [
        ...
        {key:"drafted",      label:"Drafted",                thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'},
        {key:"unsuccessful", label:"Unsuccessful eFiling",   thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'},
        {key:"total",        label:"Total Form 3 Applications", thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'}
    ]; 
    ...
    public extractInfo(){
       this.form3_info = [this.results.form3];
       this.topUser_info = [this.results.form3.top_user];
    }   
