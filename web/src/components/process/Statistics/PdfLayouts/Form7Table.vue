<template>
    <div v-if="dataReady">
        <div style="font-size:12pt; font-weight:600; margin-bottom: 0.5rem;" >Form 7: </div>
        <b-table            
            :items="form7_info"
            :fields="fields"
            bordered            
        ...
        <div style="font-size:10pt; margin-bottom: 0.5rem;" >
            <b>Total Number of Form 7 Applications:</b> {{results.form7.total}} 
        </div>
        <div 
            v-if="displayTopUser" 
...
@Component
export default class Form7Table extends Vue {
    ...
    topUserFields = [
        ...
        {key:"drafted",      label:"Drafted",                thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'},
        {key:"unsuccessful", label:"Unsuccessful eFiling",   thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'},
        {key:"total",        label:"Total Form 7 Applications", thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'}
    ]; 
    ...
    public extractInfo(){
       this.form7_info = [this.results.form7];
       this.topUser_info = [this.results.form7.top_user];
    }   
