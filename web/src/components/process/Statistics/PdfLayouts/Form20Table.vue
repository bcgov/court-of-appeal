<template>
    <div v-if="dataReady">
        <div style="font-size:12pt; font-weight:600; margin-bottom: 0.5rem;" >Form 20: </div>
        <b-table            
            :items="form20_info"
            :fields="fields"
            bordered            
        ...
        <div style="font-size:10pt; margin-bottom: 0.5rem;">
            <b>Total Number of Form 20 Applications:</b> {{results.form20.total}} 
        </div>
        <div 
            v-if="displayTopUser" 
...
@Component
export default class Form20Table extends Vue {
    ...
    topUserFields = [
        ...
        {key:"drafted",      label:"Drafted",                thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'},
        {key:"unsuccessful", label:"Unsuccessful eFiling",   thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'},
        {key:"total",        label:"Total Form 20 Applications", thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'}
    ]; 
    ...
    public extractInfo(){
       this.form20_info = [this.results.form20];
       this.topUser_info = [this.results.form20.top_user];
    }
