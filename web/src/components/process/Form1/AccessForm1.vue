...
import { accountInfoType, userAccessInfoType, form1StatusInfoType, accountUserInfoType } from '@/types/Information/Form1';
...
export default class AccessForm1 extends Vue {
    ...
    mounted() {  
        ...
        if (this.currentNoticeOfAppealId && this.form1AccessInfo && this.form1AccessInfo.length > 0){
            this.accessInfo = this.form1AccessInfo;
        } else {
    ...
    public navigateToForm1() {
        this.UpdateForm1AccessInfo(this.accessInfo);
