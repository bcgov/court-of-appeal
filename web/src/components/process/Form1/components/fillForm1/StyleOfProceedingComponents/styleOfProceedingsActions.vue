                        ...
                        <b-form-group
                            ...
                            <b-form-select
                                ...
                                <b-form-select-option 
                                    v-for="party in form1Info.parties" 
                            ...
                            <b-col cols="6">                    
                                <b-form-group
                                    ...
                                    <b-form-input 
                                        ...
                                        :state="form1PartiesStates.organizationName"             
                        ...
                        <b-row class="ml-1">
                            <b-col cols="6">                    
                                <b-form-group
                                    ...
                                    <b-form-input 
                                        id="surname"                                    
                                        :state="form1PartiesStates.surname"                  
                        ...
                        <b-row class="ml-1">
                            <b-col cols="6">
                                <b-form-group
                                    ...
                                    <b-form-input 
                                        id="first-name"                                    
                                        :state="form1PartiesStates.firstGivenName"                                                     
...
export default class styleOfProceedingsActions extends Vue {     
    ...
    //partiesList: form1PartiesInfoType[] = [];  
    party = {} as form1PartiesInfoType;    
    partyToEdit = {} as form1PartiesInfoType;
    updateTable = 0;
    ...
    public saveNewParty(){
        ...
        if (this.checkPartyStates()){
            ...
            const partiesList = this.form1Info.parties;
            const partiesListIds = partiesList.map(party => party.ceisPartyId)
            const ceisPartyId = partiesListIds.length>0? Math.max(...partiesListIds)+1 : 1
            ...
            if (this.party.isOrganization){
                ...
                this.party.fullName = getFullName(this.party);
                this.party.ceisPartyId = ceisPartyId;
            ...
            this.party.title = getPartyTitles(this.party, '</br>', false);        
    ...
    public saveParty(){
        ...
        if (this.checkPartyStates()){
            ...
            if (this.party.appealRole) {
                this.party.appealRole = ''                                                  
            }  

            // styleOfProceedings.respondents = [];
            // styleOfProceedings.appellants = [];
            // for(const party  of this.form1Info.parties){

            //     if(party.appealRole == 'Appellant')        
            //         styleOfProceedings.appellants.push(party);
            //     if(party.appealRole ==  'Respondent')        
            //         styleOfProceedings.respondents.push(party);
            // }
    ...
    public checkPartyStates(){
        ...
        if (this.party.isOrganization){
            ...
            this.form1PartiesStates.organizationName = !(this.party.organizationName)? false : null;           
            this.form1PartiesStates.lowerCourtRole = !(this.party.lowerCourtRole)? false : null;

        } else {
            this.form1PartiesStates.surname = !(this.party.surname)? false : null;
            this.form1PartiesStates.firstGivenName = !(this.party.firstGivenName)? false : null;
            this.form1PartiesStates.lowerCourtRole = !(this.party.lowerCourtRole)? false : null;
        }
        
        this.updatedPartyInfo ++;

        for(const field of Object.keys(this.form1PartiesStates)){
            if(this.form1PartiesStates[field]==false)
                stateCheck = false;
        }
    ...
    public confirmEditStyleOfProceedings(){ 
        ...
        this.UpdateForm1ManualSopOrder([...Array(styleOfProceedings.manualSop.length).keys()])

        this.UpdateForm1Info(styleOfProceedings);

        this.styleOfProceedingsInfo = JSON.parse(JSON.stringify(this.form1Info));
        this.styleOfProceedingDataReady = true;
    }


    public loadSopInfo(partiesInfo: form1PartiesInfoType[]){        
    ...
    public getPartyDisplayName(partyInfo: form1PartiesInfoType){
        let title = '';
    ...
    public saveNewStyleOfProceeding(){
        ...
        const msops = []
        for(const orderInx of this.form1ManualSopOrder){
