    ...
    <b-card v-if="mountedData" header-tag="header" bg-variant="light" border-variant="white" style="width: 80rem;" class="mx-auto">
        ...
        <b-card text-variant="dark" class="my-2 mx-5 bg-light border-light">
            ...
            <b-row class="ml-2 my-2" style="font-size: 14px;">
                ...
                order you prepared signed by all parties.  If someone refuses to sign an order, 
                you will need to make an application to extend the time for filing. 
            </b-row>
...
export default class SubmitForm13 extends Vue {
    ...
    public savePdf(){        
        ...
        const url = '/form13/form-print/'+this.currentConsentOrderExtendTimeId+'/?pdf_type='+pdfType
        const options = {
            responseType: "blob",
            headers: {
