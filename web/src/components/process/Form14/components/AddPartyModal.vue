...
import { aliasInfoType, form14PartiesInfoType, form14PartiesStatesInfoType, representativeInfoType } from '@/types/Information/Form14';
...
import {getPartyTitles, getFullName} from "./PartyTitlesForm14"
...
export default class AddPartyModal extends Vue {
    ...
    @Prop({required:true})
    party: form14PartiesInfoType;

    partyStates= {} as form14PartiesStatesInfoType;
    ...
    update = 0;
    originalParty = {} as form14PartiesInfoType
