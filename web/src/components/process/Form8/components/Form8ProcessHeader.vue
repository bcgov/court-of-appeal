        ...
        <b-row class="bg-white border-white">
            <b-col cols="4" >
                ...
                <div v-if="stepsCompleted.first">
                    ...
                    <span class="step-complete text-success ml-4 mb-2">Form 8</span>                
                </div>
                <div v-else>
                    <step-number class="ml-1 mt-2" v-bind:stepNumber="1" v-bind:active="true"/>
                    <span class="text-dark step-incomplete">Form 8</span>
                </div>               
...
export default class Form8ProcessHeader extends Vue {  
    
    @Prop({required: true})
    stepsCompleted!: form8StatusInfoType;
