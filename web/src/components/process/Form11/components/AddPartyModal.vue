...
import { aliasInfoType, form11PartiesInfoType, form11PartiesStatesInfoType, representativeInfoType } from '@/types/Information/Form11';
...
export default class AddPartyModal extends Vue {
    ...
    @Prop({required:true})
    party: form11PartiesInfoType;

    partyStates= {} as form11PartiesStatesInfoType;
    ...
    update = 0;
    originalParty = {} as form11PartiesInfoType
