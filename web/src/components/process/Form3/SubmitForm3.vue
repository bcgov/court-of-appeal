<template>
    <b-card v-if="mountedData" header-tag="header" bg-variant="light" border-variant="white" style="width: 80rem;" class="mx-auto">
        ...
        <b-card text-variant="dark" class="my-2 mx-5 bg-light border-light">
            ...
            <b-row class="ml-2 mb-1" style="font-size: 14px;">
                <b class="mr-2">Note: </b> Your Notice of Cross Appeal will be uploaded for you and you do not need to add it here. 
            </b-row>
...
export default class SubmitForm3 extends Vue {
    ...
    public submit() {
        ...
        bodyFormData.append('document_type', GetForm3PdfType(this.form3Info));
