...
import { aliasInfoType, form15PartiesInfoType, form15PartiesStatesInfoType, representativeInfoType } from '@/types/Information/Form15';
...
import {getPartyTitles, getFullName} from "./PartyTitlesForm15"
...
export default class AddPartyModal extends Vue {
    ...
    @Prop({required:true})
    party: form15PartiesInfoType;

    partyStates= {} as form15PartiesStatesInfoType;
    ...
    update = 0;
    originalParty = {} as form15PartiesInfoType
