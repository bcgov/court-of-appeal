<template>
    <b-card v-if="dataReady" header-tag="header" bg-variant="light" border-variant="white" style="width: 80rem;" class="mx-auto">
        ...
        <b-card border-variant="light" bg-variant="light" class="mt-3 mx-4">
            <form-19 @navigateToSubmitPage="navigateToSubmitPage" @pdfReady="pdfReady=true" />            
        </b-card>
...
import Form19 from "@/components/process/Form19/components/pdf/Form19.vue"
...
export default class PreviewForm19 extends Vue {
    ...
    public navigateToSubmitPage() {
        this.$router.push({name: "proceed-form19"}); 
    }
}
</script>
