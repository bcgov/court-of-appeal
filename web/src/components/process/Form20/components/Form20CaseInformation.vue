<template>
    <b-card v-if="dataReady" class="ml-4 border-white">
        ...
        <p class="mt-3">
            Find the Court of Appeal case that you are creating a Notice of Objection 
            to Withdrawal for by entering the following case information:
        </p>
...
import { form20SearchInfoType } from '@/types/Information/Form20';
...
export default class Form20CaseInformation extends Vue {
    ...
    searchParams = {} as form20SearchInfoType;
    notFound = false;
    partyOptions = [
