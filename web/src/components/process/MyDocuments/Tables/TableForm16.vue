<template>
    <div> 
        ...
        <b-row v-if="enableActions && documentsList.length" class="bg-form16 mb-2 py-1 mx-0">
            <b-col cols="10">
                <div style="font-weight:600; font-size:14pt; margin:0 0 0 18rem;" class="p-0 text-center text-primary">Offer To Settle Costs (Form 16)</div>
            </b-col>
            <b-col  cols="2">
                <b-button 
        ...
        <b-row v-else-if="documentsList.length" class="bg-select mb-2 py-1 mx-0">
            <b-col cols="12">
                <div 
                    ...
                    class="p-0 text-center text-primary">Offer To Settle Costs (Form 16) </div>
            </b-col>
        </b-row>
...
@Component
export default class TableForm16 extends Vue {
