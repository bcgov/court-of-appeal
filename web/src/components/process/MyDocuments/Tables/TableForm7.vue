<template>
    <div> 
        ...
        <b-row v-if="enableActions && documentsList.length" class="bg-form7 mb-2 py-1 mx-0">
            <b-col cols="10">
                <div style="font-weight:600; font-size:14pt; margin:0 0 0 18rem;" class="p-0 text-center text-primary">Notice of Urgent Application (Form 7)</div>
            </b-col>
            <b-col  cols="2">
                <b-button 
        ...
        <b-row v-else-if="documentsList.length" class="bg-select mb-2 py-1 mx-0">
            <b-col cols="12">
                <div style="font-weight:600; line-height:1rem; font-size:12pt; margin:0 0 0 0rem;" class="p-0 text-center text-primary">Notice of Settlement or Abandonment (Form 7) </div>
            </b-col>
        </b-row>
        ...
        <b-modal size="lg" v-model="confirmDelete" id="bv-modal-confirm-delete" header-class="bg-danger text-light">                    
            ...
            <h4 v-if="applicationsToDelete.length>0">Are you sure you want to delete the selected <b>"{{applicationsToDelete.join(', ')}}"</b> <b class="text-danger"> Notice of Urgent Application </b> submission<span v-if="applicationsToDelete.length>1" >s</span>?</h4>            
...
export default class TableForm7 extends Vue {
    ...
    public resumeApplication(fileInfo: documentInfoType) {
        ...
        this.UpdateCurrentNoticeOfUrgentApplicationId(caseId);             
