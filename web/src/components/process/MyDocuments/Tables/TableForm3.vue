<template>
    <div> 
        ...
        <b-row v-if="enableActions && documentsList.length" class="bg-form3 mb-2 py-1 mx-0">
            <b-col cols="10">
                <div style="font-weight:600; font-size:14pt; margin:0 0 0 18rem;" class="p-0 text-center text-primary">Notice of Cross Appeal (Form 3)</div>
            </b-col>
            <b-col  cols="2">
                <b-button 
        ...
        <b-row v-else-if="documentsList.length" class="bg-select mb-0 py-1 mx-0">
            <b-col cols="12">
                <div style="font-weight:600; line-height:0.6rem; font-size:10pt; margin:0 0 0 0rem;" class="p-0 text-center text-primary">Notice of Cross Appeal (Form 3) </div>
            </b-col>
        </b-row>
