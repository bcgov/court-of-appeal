<template>
    <div> 
        ...
        <b-row v-if="enableActions" class="bg-select mb-2 py-1 mx-0">
            <b-col cols="10">
                <div style="font-weight:600; font-size:14pt; margin:0 0 0 18rem;" class="p-0 text-center text-primary">Form 2</div>
            </b-col>
            <b-col  cols="2">
                <b-button 
        ...
        <b-row v-else class="bg-select mb-2 py-1 mx-0">
            <b-col cols="9">
                <div style="font-weight:600; line-height:1rem; font-size:12pt; margin:0 0 0 24rem;" class="p-0 text-center text-primary">Form 2</div>
            </b-col>
        </b-row>
        ...
        <b-modal size="lg" v-model="confirmDelete" id="bv-modal-confirm-delete" header-class="bg-danger text-light">                    
            ...
            <h4 v-if="applicationsToDelete.length>0">Are you sure you want to delete the selected <b>"{{applicationsToDelete.join(', ')}}"</b> <b class="text-danger"> Notice of Appearance </b> application<span v-if="applicationsToDelete.length>1" >s</span>?</h4>            
...
export default class TableForm2 extends Vue {
