    ...
    <div v-if="dataReady">
        ...
        <div style="margin-top:-1.25rem;">
            ...
            <div class="row" style="margin-top: 0.75rem; text-align: center; border: 1px solid black; line-height: 3rem;">
                ...
                <div style="width:75%; font-size:14pt; line-height:2rem;">
                    <b>
        ...
        <div class="mt-4" style="display:flex; font-size: 9pt;">
            ...
            <div class="coa-arrow-box-left" style="width:32%; margin:.5rem 0;  height:6.5rem;">
                <div class="ml-2">
                    <b>
                        Name(s) of person(s) or lawyer completing the notice of change of
        ...
        <div class="mt-4" style="display:flex; font-size: 9pt;">
            ...
            <div class="coa-arrow-box-left" style="width:32%; margin:.5rem 0;  height:6.5rem;">
                <div class="ml-2">
                    <b>
                        If form completed by lawyer, name(s) of person(s) you
                        are/were representing
                    </b>
                </div>
            </div>
            ...
            <div class="coa-text-box-left" style="width:60%;">
                <div class="mx-2">{{result.nameOfLawyer}}</div>
            </div>
        ...
        <div style="border: 1px solid #E8E8E8; background:#E8E8E8; font-size: 10pt; margin: 0.5rem 0; text-align: left; padding:0 0.5rem;">
            <div class="row" style="font-size: 12pt; margin: 0 0.5rem; font-weight: 700;"><b class="mr-3">PART A</b></div>

            <div style="width:100%;">
                <!-- <col 93%> -->
                <!-- ROW <current-status> -->
                <div style="display:flex; font-size: 9pt;">
                    <div class="coa-arrow-box-right" style="background:#FFF;width:28%; margin:.5rem 0px; height:3.5rem;">
                        <div style="margin-left:4.5rem"><b>Current status:</b></div>
                    </div>

                    <div class="arrow-right-flash-36" style="border-left-color: #FFF;"></div> <!-- < width ~ 8% > -->

                    <div style="margin-top: 1rem; width:24%;">
                        <check-box style="margin: .5rem 0 0 1rem;"
                    ...
                    <div style="margin-top: 1rem; width:12%;">
                        <check-box style="padding: 0; margin: .5rem .5rem 0 1rem;"
                                   :check="currentLawyer?'yes':''"
                                   shiftmark="1"
                                   marginLeft="0.5rem"
                                   text="Lawyer" />
                    </div>
                    <div class="coa-text-box-center"
                         style="width:31%; background:#FFF;">
                        {{currentLawyerName}}
                    </div>
                </div>

                <!-- ROW <current-status-help-text> -->
                <div style="display:flex; font-size: 9pt;margin: 0.05rem 0;">
                    <div style="width:69%;">
                    </div>
                    <div style="width:31%;">
                        <div class="coa-help-box"
                             style="text-align:center; line-height:0.7rem; ">
                            Name of lawyer and firm name
                        </div>
                    </div>
                </div>
                ...
                <div style="display:flex; font-size: 9pt;">
                    <div class="coa-arrow-box-right" style="background:#FFF; width:28%; margin:.5rem 0px; height:3.5rem;">
                        <div style="margin-left:5.35rem;"><b>New status:</b></div>
                    </div>
                ...
                <!-- ROW <current-status-help-text> -->
                <div style="display:flex; font-size: 9pt; margin: 0.06rem 0;">
                    <div style="width:69%;">
                    </div>
                    <div style="width:31%;">
                        <div class="coa-help-box"
        ...
        <div style="border: 1px solid #E8E8E8; background:#E8E8E8; font-size: 10pt; margin: 0.5rem 0; text-align: left; padding:0 0.5rem;">
            <div class="row" style="font-size: 12pt; margin: 0 0.5rem; font-weight: 700;"><b class="mr-3">PART B</b></div>
            ...
            <div style="width:100%;">
                ...
                <div style="display:flex; font-size: 9pt;">
                    ...
                    <div class="coa-arrow-box-left" style="background:#FFF;width:32%; margin:.5rem 0px; height:6.5rem;">
                        <div class="ml-2">
                            <b>
                    ...
                    <div class="coa-text-box-left" style="width:60%;background:#FFF;">
                ...
                <div class="mt-4" style="display:flex; font-size: 9pt;">
                    ...
                    <div class="coa-arrow-box-left" style="background:#FFF;width:32%; margin:.5rem 0; height:3.5rem;">
                ...
                <!-- <email> -->
                <div class="my-4" style="display:flex; font-size: 9pt;">

                    <div class="coa-arrow-box-left" style="background:#FFF;width:32%; margin:.5rem 0;  height:6.5rem;">
                        <div class="ml-2">
