<template>
    <b-card v-if="dataReady" class="ml-4 border-white">
        ...
        <p class="mt-3">
            Find the Court of Appeal matter that you are creating the Notice of Change of 
            Representation/Change of Address for Service by entering the following case 
            information.
        </p>
...
import { form18SearchInfoType } from '@/types/Information/Form18';
...
export default class Form18CaseInformation extends Vue {
    ...
    searchParams = {} as form18SearchInfoType;
    notFound = false;
    partyOptions = [
