<template>
    <b-card v-if="dataReady" class="ml-4 border-white">
        ...
        <p class="mt-3">
            Find the Court of Appeal case that you are wanting to 
            create an Offer To Settle Costs form for by entering 
...
import { form16SearchInfoType } from '@/types/Information/Form16';
...
export default class Form16CaseInformation extends Vue {
    ...
    searchParams = {} as form16SearchInfoType;
    notFound = false;
    partyOptions = [
