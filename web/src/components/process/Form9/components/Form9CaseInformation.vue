<template>
    <b-card v-if="dataReady" class="ml-4 border-white">
        ...
        <p class="mt-3">
            Find the Court of Appeal file number that you want to create a 
            Requisition for by entering the following case information:
        </p>
...
export default class Form9CaseInformation extends Vue {
    ...
    searchParams = {} as form9SearchInfoType;
    notFound = false;
    partyOptions = [
