...
import { aliasInfoType, form12PartiesInfoType, form12PartiesStatesInfoType, representativeInfoType } from '@/types/Information/Form12';
...
export default class AddPartyModal extends Vue {
    ...
    @Prop({required:true})
    party: form12PartiesInfoType;

    partyStates= {} as form12PartiesStatesInfoType;
    ...
    update = 0;
    originalParty = {} as form12PartiesInfoType
